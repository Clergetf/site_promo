				...
				<div class="single-member--wraper" itemscope itemtype="http://schema.org/Organization">
					...
					<div class="single-member fullcolumn">
						...
						<div class="gs-roow">
							...
							<div class="col-md-8 col-sm-8 col-xs-12 cbp-so-side cbp-so-side-left gstm-img-div">
							...
							<div class="col-md-4 col-sm-4 col-xs-12 cbp-so-side cbp-so-side-right gstm-img-div">
