<?php
/**
 * GS Team - Layout Table Odd Even
 * @author GS Plugins <hello@gsplugins.com>
 * 
 * This template can be overridden by copying it to yourtheme/gs-team/gs-team-layout-table-odd-even.php
 * 
...
<div class="gs-containeer">
	...
	<?php if ( $gs_team_loop->have_posts() ): ?>
		...
		<div class="gs_team_table_oddeven">
